...
class Old_Patient(models.Model):
    ...
    md_name                     = models.CharField(max_length=200,blank=True,verbose_name="Doctor's Name")
    md_id                       = models.CharField(max_length=200,blank=True,)
    md_address                  = models.CharField(max_length=1000,blank=True,verbose_name="Doctor's Address")
    md_phone                    = models.CharField(max_length=200,blank=True,verbose_name="Doc's phone")
