...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Old_Patient.status_notes'
        db.alter_column('old_patient_reg_old_patient', 'status_notes', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Old_Patient.status_notes'
        db.alter_column('old_patient_reg_old_patient', 'status_notes', self.gf('django.db.models.fields.TextField')(default=''))
    ...
    models = {
        'old_patient_reg.old_patient': {
            ...
            'back_up_phone': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
