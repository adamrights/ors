...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Old_Patient.md_address'
        db.alter_column('old_patient_reg_old_patient', 'md_address', self.gf('django.db.models.fields.CharField')(max_length=1000))


    def backwards(self, orm):
        
        # Changing field 'Old_Patient.md_address'
        db.alter_column('old_patient_reg_old_patient', 'md_address', self.gf('django.db.models.fields.CharField')(max_length=300))
    ...
    models = {
        'old_patient_reg.old_patient': {
            ...
            'back_up_phone': ('django.db.models.fields.CharField', [], {'max_length': '90', 'blank': 'True'}),
            ...
            'md_address': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'blank': 'True'}),
